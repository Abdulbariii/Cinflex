...
export default function MovieDetail() {
  ...
  return (
    <div className=" overflow-hidden">
      {/* Back  */}
      <p
        className="text-white ml-[4rem] mt-[2rem]"
        onClick={() => {
          Navigate("/movies");
        }}
      >
      ...
      {data && (
        <div
          className=" lg:mt-[4rem] md:mt[3rem] sm:mt[3rem] flex lg:ml-[20%]   gap-[3rem] 
               text-white
sm: flex-col
lg:flex-row 
               "
        >
          ...
          <div className="self-center ">
            {/* btn */}
            <button className={`${color} p-3 text-center`}>Watch now</button>
            ...
            <p className="lg:pr-[24rem] text-justify ">
              {" "}

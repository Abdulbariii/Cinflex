...
'>
 ...
 <div className='flex gap-14  '>   <label className='py-2 opacity-90'>Full Name</label>
    ...
    shadow-sm p-2  bg-slate-50 placeholder-gray-400 placeholder-opacity-50'  onChange={(e)=>{setFullName(e.target.value)}} required/></div>
    {/* email */}
 <div className='flex opacity-90 gap-9 -m-2  '>   <label className='py-2'>Email Address</label>
    <input className='
    shadow-sm p-2 bg-slate-50 placeholder-gray-400 placeholder-opacity-50'  type="text" placeholder='Email Address' onChange={(e)=>{setEmail(e.target.value)}} required/></div>
    {/* Password */}
    <div className='flex gap-12 '><label className='opacity-90 p-2' >Password</label>
    <input className='
    shadow-sm p-2 bg-slate-50 placeholder-gray-400 placeholder-opacity-50'  type="text" placeholder='Password' onChange={(e)=>{setPassword(e.target.value)}} required/></div>
...
<label className='opacity-90 p-2  '>comfirm Password</label>
  ...
  <span> </span> I Agree All statments In Term Of servise 
    ...
    <Button className=' w-fit '
     variant='contained' onClick={register}>Create an account</Button>

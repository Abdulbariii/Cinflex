...
export default function PlayMovies({ dataServer }) {
  ...
  return (
    <div className="mt-32">
      ...
      <div className=" flex  lg:flex-row md:flex-row flex-col md:gap-10 lg:gap-10 relative  mt-5  w-full justify-between items-start">
        <iframe
          src={
        ...
        <div>
          ...
          <ul className=" lg:flex-col md:flex-col  sm:flex-row justify-center flex-wrap  text-transparent items-center leading-snug font-Main  flex gap-8 text-2xl  text-white    ">
            {servers.map((server) => (
              <div>
                <li
                  onClick={() => {
